    ...
    <div class="container annual-event">
        ...
        <section>
          ...
          <div class="contents chart">
            ...
            <div class="gradually-appear-long">
              <div class="note">表内のリンク（赤下線）から詳細をご覧いただけます。</div>
              <ul class="list-contents">
                ...
                <li>
                  ...
                  <div class="subject">
                    <div>節分祭（鬼遣い豆まき神事）柊大明神例祭&emsp;16：00</div>
                ...
                <li>
                  ...
                  <div class="subject">
                    <div><span class="modal-open-trigger apl-14">春季例大祭&emsp;淳仁天皇祭</span>（蹴鞠奉納）10：30&emsp;※蹴鞠体験可</div>
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div class="subject">
                    <div><span class="modal-open-trigger jul-07-01">精大明神例祭「七夕祭」</span></div>
                    <div><span class="before-emsp">蹴鞠奉納</span>&emsp;13：30</div>
                    <div><span class="modal-open-trigger before-emsp jul-07-02">小町をどり奉納奉告祭</span>&emsp;16：00</div>
                  </div>
                </li>
                <li>
                  <div class="date">8月15日</div>
                  <div class="subject">戦没者慰霊祭&emsp;11：30&emsp;正午の時報にあわせ黙祷</div>
                </li>
                <li>
                  <div class="date">9月21日</div>
                  <div class="subject">
                    <div><span>秋季例大祭</span></div>
                    <div><span class="before-emsp">崇徳天皇祭</span>&emsp;11：00</span></div>
                ...
                <li>
                  ...
                  <div class="subject row"><span class="modal-open-trigger oct-full-moon">献燈祭観月の夕べ</span>&emsp;18：00</div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div class="subject">
                    <div>新嘗祭（日供講祭・<span class="modal-open-trigger nov-23-01">献茶祭</span>・潜龍社祭・<span class="modal-open-trigger nov-23-02">御火焚祭</span>）
                    </div>
                  </div>
                </li>
                <li>
      ...
      <div class="modal apl-14">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">apl-14</h4>
          <div class="flex-grid">
      ...
      <div class="modal may-05-01">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">may-05-01</h4>
          <div class="flex-grid">
            <div class="paragraph">
      ...
      <div class="modal may-05-02">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">may-05-02</h4>
          <div class="flex-grid">
            <figure>
      ...
      <div class="modal jun-30">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">jun-30</h4>
      ...
      <div class="modal july-07-01">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">july-07-01</h4>
          <div class="flex-grid">
            <div class="paragraph">
      ...
      <div class="modal jul-07-02">
        <div class="container">
          <button class="modal-close-btn">
            <span></span>
            <span></span>
          </button>
          <h4 class="guide-shrine-modal-header"><ruby>jul-07-02<rt>ガンシュウゲ</rt></ruby></h4>
          <div class=" flex-grid">
            <div class="paragraph">
              <dl class="technical-name">
                <div>
      ...
      <div class="modal sep-21">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">sep-21</h4>
          <div class="flex-grid">
            <div class="paragraph">
              <dl class="technical-name">
                <div>
      ...
      <div class="modal oct-full-moon">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">oct-full-moon</h4>
          <div class=" flex-grid">
            <div class="paragraph">
              <dl class="technical-name">
                <div>
      ...
      <div class="modal nov-15">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">nov-15</h4>
          <div class=" flex-grid">
            <div class="paragraph">
              <dl class="technical-name">
                <div>
      ...
      <div class="modal nov-23-01">
        <div class="container">
          ...
          <h4 class="guide-shrine-modal-header">nov-23<span class="left-side">（</span>黄桜<span class="right-side">）</span></h4>
          <div class=" flex-grid">
            <div class="paragraph">
              <dl class="technical-name">
                <div>
