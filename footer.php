    ...
    <div class="wrapper">
      ...
      <div class="wrapper-grid">
        ...
        <div class="footer-right-links">
          <ul class="banner">
            <li><a href=""><img class="logo" src="<?php echo get_template_directory_uri(); ?>/img/banner-01.png" alt=""></a></li>
            <li><a href=""><img class="logo" src="<?php echo get_template_directory_uri(); ?>/img/banner-02.png" alt=""></a></li>
            <li><a href=""><img class="logo" src="<?php echo get_template_directory_uri(); ?>/img/banner-03.png" alt=""></a></li>
            <li><a href=""><img class="logo" src="<?php echo get_template_directory_uri(); ?>/img/banner-04.png" alt=""></a></li>
          </ul>
        </div>
      </div>
